...
public class UserController {
	...
	public ResponseEntity<UserDTO> editUserPassword(@RequestBody UserDTO dto) {
		try {

			return new ResponseEntity<UserDTO>(iUserService.editPassword(dto), HttpStatus.OK);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public ResponseEntity<UserDTO> findUserByEmail(@RequestBody UserDTO dto) {
		try {
			return new ResponseEntity<UserDTO>(iUserService.findByEmail(dto), HttpStatus.OK);
		} catch (Exception e) {
			e.printStackTrace();
